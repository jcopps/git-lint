...
* As the repo name suggests, the project has been customised to make it suitable for a pull request raised in Github. 

Unfortunately, the owner sk- had decided to deprecate this package. This fork will be continued for support for any future issues raised.
